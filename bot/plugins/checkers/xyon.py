...
async def _(m , cards , gate_db , user_db , lang, *args,**kwargs ):
    ...
    if spam_time < timee:
        ...
        try:
            ...
            return await m.client.send_message(LOG_CHAT, f"BadRequestError in Xyon Gate")
